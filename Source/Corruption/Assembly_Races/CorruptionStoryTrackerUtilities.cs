...
namespace Corruption
{
    ...
    public class CorruptionStoryTrackerUtilities
    {
        ...
        public static Texture2D SelectorHighlightTex = ContentFinder<Texture2D>.Get("UI/HeroArt/Storytellers/Highlight", true);
   ...
   //         Widgets.DrawRectFast(position, faction.Color, null);
        ...
        public static void AffectGoodwillWithSpacerFaction(Faction faction, Faction other, float goodwillChange)
        {
            ...
            {
                faction.TrySetRelationKind(other, FactionRelationKind.Hostile);
        ...
        {
            if (CFind.StoryTracker.PlanetaryGovernor == null)
            {
                return;
            }
            Faction faction = CFind.StoryTracker.ImperialGuard;
            ...
            dropShip.refuelableComp.Refuel(2000);
            ...
            DropShipUtility.DropShipGroups(dropCenter, map, tmp, ShipArrivalAction.EnterMapFriendly);
        ...
        public static void CreateTributePickup(Map map, Faction faction, PawnKindDef pawnKind, int numHaulers, Missions.Mission mission = null)
        {
        ...
        public static void GrantResearch(ResearchProjectDef def)
        {
            ...
            manager.FinishProject(def, false);
