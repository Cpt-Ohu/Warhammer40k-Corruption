    ...
    public class Dialog_ChooseBattleSides : Window
    {
        ...
        private string curFactionName
        {
            get
            {
                ...
                else if (this.battleZone.PlayerChosen == CFind.StoryTracker.DominationTracker.PlayerAlliance)
                {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            if (Widgets.ButtonText(selectorRect, curFactionName, true, false, true))
            {
                ...
                list.Add(new FloatMenuOption("BattleAttackBoth".Translate(), delegate { battleZone.PlayerChosen = CFind.StoryTracker.DominationTracker.PlayerAlliance; }, MenuOptionPriority.Default, null, null, 0, null));
