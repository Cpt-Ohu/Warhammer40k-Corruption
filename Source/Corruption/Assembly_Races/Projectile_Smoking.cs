...
namespace Corruption
{
    ...
    {        
        ...
        protected override void Impact(Thing hitThing)
        {
            ...
            else
            {
                if (hitThing != null)
                {
                    ...
                    DamageInfo dinfo = new DamageInfo(this.def.projectile.damageDef, damageAmountBase, base.ArmorPenetration, this.ExactRotation.eulerAngles.y, this.launcher, null, equipmentDef, DamageInfo.SourceCategory.ThingOrUnknown);
                ...
                else
                {
                    ...
                    {
                        MoteMaker.MakeWaterSplash(this.ActualPosition, map, Mathf.Sqrt((float)this.def.projectile.GetDamageAmount(1f)) * 1f, 4f);
                    }
                }
            }
            this.istraveling = false;
        ...
        protected virtual void Explode()
        {
            ...
            GenExplosion.DoExplosion(base.Position, map, this.def.projectile.explosionRadius, this.def.projectile.damageDef, this.launcher, this.def.projectile.GetDamageAmount(1f),1f, this.def.projectile.soundExplode, this.def, this.equipmentDef, null, this.def.projectile.postExplosionSpawnThingDef, this.def.projectile.postExplosionSpawnChance, 1, false, preExplosionSpawnThingDef, explosionSpawnChance, 1);
        }
