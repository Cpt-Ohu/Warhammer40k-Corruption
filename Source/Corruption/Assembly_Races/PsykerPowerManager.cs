    ...
    public class PsykerPowerManager : IExposable
    {
        ...
        public List<PsykerPowerEntry> AllPsykerPowers
        {
            get
            {
                ...
                result.AddRange(this.IotaPowers);
                result.AddRange(this.ZetaPowers);
                result.AddRange(this.EpsilonPowers);
                result.AddRange(this.DeltaPowers);
                result.AddRange(this.EquipmentPowers);
                return result;
            }
        }
