...
{
    public class Bill_MedicalTable : Bill
    {
        ...
        private Pawn GiverPawn
        {
            get
            {
                Building_MechanicusMedTable medTable = this.billStack.billGiver as Building_MechanicusMedTable;
                Pawn pawn = medTable.patient;

                if (pawn == null)
                {
                    throw new InvalidOperationException("MedicalTable Bill on non-pawn.");
                }
                return pawn;
            }
        }
        ...
        public Bill_MedicalTable()
        {
        }

        public Bill_MedicalTable(RecipeDef recipe) : base(recipe)
		{
        }
