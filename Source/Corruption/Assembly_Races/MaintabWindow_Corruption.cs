...
namespace Corruption
{
    public class MaintabWindow_Corruption : MainTabWindow
    {
        ...
        private Worship.WorshipTabUtility worshipTab = new Worship.WorshipTabUtility();
        ...
        {
            Worship.WorshipTabUtility.SelectedGod = CorruptionStoryTrackerUtilities.CurrentStoryTracker.PlayerGod;
            base.PreOpen();
        }
