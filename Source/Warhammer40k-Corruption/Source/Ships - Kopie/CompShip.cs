...
namespace OHUShips
{
    public class CompShip : ThingComp
    {
        ...
        public override void Initialize(CompProperties props)
        {
            ...
            Log.Message("Init " + this.weaponSlots.Count + " vs " + this.sProps.weaponSlots.Count);
            this.weaponSlots.AddRange(this.sProps.weaponSlots);
            Log.Message("After " + this.weaponSlots.Count);
        }
