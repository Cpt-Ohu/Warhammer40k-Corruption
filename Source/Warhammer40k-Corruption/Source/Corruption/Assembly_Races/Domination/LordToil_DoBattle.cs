...
namespace Corruption.Domination
{
    public class LordToil_DoBattle : LordToil
    {
        ...
        public override void UpdateAllDuties()
        {
            ...
            {
                this.lord.ownedPawns[i].mindState.duty = new PawnDuty(DominationDefOfs.DoBattleDuty, this.Data.defendPoint, this.Data.defendRadius);
            }
        }

        public void ResetDefentPoint(IntVec3 newPoint)
        {
            this.Data.defendPoint = newPoint;
